  ...
  public: {
    Tables: {
      ...
      ai_provider_attempts: {
        ...
        Relationships: [
          {
            foreignKeyName: 'ai_provider_attempts_message_id_fkey';
            columns: ['message_id'];
            isOneToOne: false;
            referencedRelation: 'ai_messages';
            referencedColumns: ['id'];
      ...
      ai_user_states: {
        Row: {
          ...
          telegram_control_message_id: number | null;
          updated_at: string;
          user_id: string;
        };
        Insert: {
    ...
    Functions: {
      ...
      acquire_ai_provider: {
        Args: {
          p_half_open_lease_seconds: number;
          p_now?: string;
          p_provider: string;
        };
        Returns: Json;
      ...
      record_ai_provider_failure: {
        ...
        SetofOptions: {
          from: '*';
          to: 'ai_provider_runtime_state';
          isOneToOne: true;
          isSetofReturn: false;
        };
      };
      record_ai_provider_success: {
        Args: {
          p_base_cooldown_seconds: number;
          p_now?: string;
          p_provider: string;
